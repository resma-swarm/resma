...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/storage/volumes/{name}/growth": {
            "get": {
                "security": [
                    {
                        "APIKeyAuth": []
